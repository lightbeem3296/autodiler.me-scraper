...
if __name__ == "__main__":
    brand_id, brand_seo = get_brand_id_seo("Mazda")
    product_id = get_product_id(brand_id, "CX-5")
    print(brand_id, brand_seo)
    print(product_id)
    print(fetch_products(manufacturer="Mazda", model="CX-5"))
